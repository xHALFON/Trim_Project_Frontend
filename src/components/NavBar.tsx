  ...
  return (
    <div className="bg-blue-900 p-4 z-10 relative">
      <div className="flex flex-wrap justify-between lg:justify-around items-center">
        ...
        <Link to="/">
          <div className="text-xl md:text-2xl cursor-pointer text-white font-bold hover:text-gray-200">
            Trim Network
          </div>
        </Link>
  
        {/* חיפוש - יופיע רק במסכים רחבים */}
        <span className="hidden md:block w-full md:w-1/3 mt-4 md:mt-0">
        ...
        <div className="flex items-center space-x-4 md:space-x-6 mt-4 md:mt-0">
          <Link to="/">
            <FaHome className="text-lg md:text-2xl text-white cursor-pointer hover:text-gray-200" />
          </Link>
          <Link to="/profile">
            <FaUser className="text-lg md:text-2xl text-white cursor-pointer hover:text-gray-200" />
          </Link>
          <div
            className="relative"
          ...
          >
            <FaCog className="text-lg md:text-2xl text-white cursor-pointer hover:text-gray-200" />
            {isDropdownOpen && (
              <div
